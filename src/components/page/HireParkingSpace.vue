...
<div>
    ...
    <div class="container" v-show="active==3">
        ...
        <el-form :label-position="labelPosition" label-width="80px" :model="costInfo">
            <el-form-item label="缴费周期">
                <el-select v-model="costInfo.cycle" placeholder="必填，请选择缴费周期" style="width:100%" @change="handleChange(costInfo.cycle)">
    ...
    <div>
        ...
        <el-button v-show="active==3" style="margin-top: 12px; float:right" @click="hireParkingSpace">出租</el-button>
...
export default {
    ...
    methods: {
        ...
        updateParkingSpace() {
            this.parkingSpaceRowInfo.status = 1
